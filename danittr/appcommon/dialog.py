...
class MessageScreen(object):
    ...
    def set_press_prompt(self):
        ...
        """
        self.press_prompt = \
                      render_text("Press any key to exit",
                                   font_size=32,
    ...
    def cache_message(self, message_name, text):
        ...
        """
        obj = render_text(text, font_size=32,
                          foreground_color=WHITE,
                          return_obj=True)
    ...
    def display_message(self, message_name, update_manager,
                        extra_routine=None):
    ...
    def draw(self):
        ...
        SCREEN.blit(self.press_prompt.image,
                    self.press_prompt.rect)
