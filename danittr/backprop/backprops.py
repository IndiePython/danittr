...
class StaticBackProp(BasicObject):
    ...
    prop_map = {
      ...
      "dirt_darker_back_prop" : \
          render_image("dirt_darker_back_prop.png"),
      "stone_darker_back_prop" : \
          render_image("stone_darker_back_prop.png"),
      "sand_back_prop" : \
          render_image("sand_back_prop.png"),
      "stone_back_prop" : \
          render_image("stone_back_prop.png")
    }
