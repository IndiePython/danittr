...
class VinesLadder(BasicObject):
    ...
    prop_map = {
      ...
      "vines_grid_climbable" : \
          render_image("vines_grid_climbable.png"),
    ...
    def __init__(self, prop_name, coordinates):
        ...
        if isinstance(prop_value, str):
            prop_value = load_image(prop_value
                                    ).convert_alpha()
...
class SimpleDoor(BasicObject):
    ...
    prop_map = {
      "simple_door" : render_image("simple_door.png")
    }
    
    def __init__(self, prop_name, coordinates, next_level,
                 portal_name, destination):
        """Initialize superclass and variables.
...
class CaveEntrance(BasicObject):
    ...
    prop_map = {
      "cave_entrance" : render_image("cave_entrance.png")
    }
