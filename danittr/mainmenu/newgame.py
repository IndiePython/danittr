...
from ..config import (
                   SCREEN, SCREEN_RECT, SAVES_DIR,
                   GAME_REFS)

from ..appcommon.task import (
                                     update_task_manager)
from ..appcommon.surf import (
                                     INVISIBLE_SURF,
                                     render_rect)
...
class NewGameWidget(object):
    ...
    def __init__(self, main_menu):
        ...
        cache_message(
               "three_or_more",
               "Save name must have 03 or more characters.")
        cache_message("name_exists",
                      "The name you picked already exists.")
        cache_message(
               "ten_or_less",
               "Save name must have 10 or less characters.")
    ...
    def set_labels(self):
        ...
        for text in label_texts:
            ...
            label = render_text(text, font_size=32,
...
class TextPrompt:
    ...
    def __init__(self, topleft, new_game_widget):
        ...
        seed()
        self.typing_sounds = [
          SOUNDS_MAP["key_typing01"],
          SOUNDS_MAP["key_typing02"]
        ]
    ...
    def insert_char(self, char):
        ...
        if len(self.save_name) < 10:
            ...
            display_message("ten_or_less",
                            self.new_game_widget)
...
class BlinkingCursor:
    ...
    def blit_on_topleft(self, topleft):
        ...
        """
        if self.blit(): SCREEN.blit(self.image, topleft)
