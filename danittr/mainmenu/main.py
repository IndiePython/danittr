...
class MainMenu:
    ...
    def build_items(self):
        ...
        for name in self.widget_names:
            ...
            menu_widget.image = \
                          give_depth_finish(menu_widget.image)
    ...
    def draw(self):
        ...
        SCREEN.blit(
          self.game_logo.image, self.game_logo.rect)
    ...
    def load_last_save(self):
        ...
        for directory in listdir(SAVES_DIR):
            ...
            state_path = \
                  join(SAVES_DIR, directory, STATE_FILE_NAME)
